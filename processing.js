...
//   ]];
    ...
    model = await tf.loadLayersModel('./tj/model.json');
    // const result = model.predict(myTensor).argMax(-1);
    // result.print();
    // console.log(`MyTensor: ${myTensor}`);
    // console.log(`Shape of Tensor: ${myTensor.shape}`);
    // console.log(`dtype of Tensor: ${myTensor.dtype}`);
...
function predictImage() {
    ...
    // console.log(`I have such tensor: ${X}`);
    // console.log(`Shape of Tensor: ${X.shape}`);
    // console.log(`dtype of Tensor: ${X.dtype}`);

    const result = model.predict(X).argMax(-1);
    result.print();
